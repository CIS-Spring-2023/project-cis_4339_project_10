            ...
            <div class="flex flex-col">
              <template v-for="(service, index) in services" :key="index">
                <label :for="service._id" class="inline-flex items-center">
                  <input type="checkbox" :id="service._id" :value="service" v-model="event.services"
          ...
          <div class="flex flex-col">
            <label class="block">
              ...
              <span class="text-black" v-if="v$.event.address.line1.$error">
                <p class="text-red-700" v-for="error of v$.event.address.line1.$errors" :key="error.$uid">
                  {{ error.$message }}!
                </p>
              </span>
            </label>
          ...
          <div class="flex flex-col">
            <label class="block">
              ...
              <span class="text-black" v-if="v$.event.address.city.$error">
                <p class="text-red-700" v-for="error of v$.event.address.city.$errors" :key="error.$uid">
                  {{ error.$message }}!
                </p>
              </span>
            </label>
          ...
          <div class="flex flex-col">
            <label class="block">
              ...
              <span class="text-black" v-if="v$.event.address.zip.$error">
                <p class="text-red-700" v-for="error of v$.event.address.zip.$errors" :key="error.$uid">
                  {{ error.$message }}!
                </p>
              </span>
            </label>
